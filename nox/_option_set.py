...
class OptionSet:
    ...
    def add_group(self, name, *args, **kwargs):
        ...
        This will use ``ArgumentParser.add_argument_group`` to group options
        together.
        """
    ...
    def parser(self):
        ...
        groups = {
            key: parser.add_argument_group(*value[0], **value[1])
    ...
    def _finalize_args(self, args):
        ...
        for option in self.options.values():
            ...
            # Handle options whose default value is a function
            if value == option.default and callable(value):
    ...
    def namespace(self, **kwargs):
        ...
        for key, value in kwargs.items():
            if key not in args:  # pragma: no cover
